...
module unsaved_mm_interconnect_0 (
	...
	wire  [17:0] accelerometer_avalon_accelerometer_spi_mode_slave_agent_m0_address;                    // accelerometer_avalon_accelerometer_spi_mode_slave_agent:m0_address -> accelerometer_avalon_accelerometer_spi_mode_slave_translator:uav_address
	...
	wire  [67:0] accelerometer_avalon_accelerometer_spi_mode_slave_agent_rf_source_data;                // accelerometer_avalon_accelerometer_spi_mode_slave_agent:rf_source_data -> accelerometer_avalon_accelerometer_spi_mode_slave_agent_rsp_fifo:in_data
	...
	wire  [67:0] accelerometer_avalon_accelerometer_spi_mode_slave_agent_rsp_fifo_out_data;             // accelerometer_avalon_accelerometer_spi_mode_slave_agent_rsp_fifo:out_data -> accelerometer_avalon_accelerometer_spi_mode_slave_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_001_src_data;                                                                  // cmd_mux_001:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire   [4:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire  [17:0] nios2_jtag_debug_module_agent_m0_address;                                              // nios2_jtag_debug_module_agent:m0_address -> nios2_jtag_debug_module_translator:uav_address
	...
	wire  [94:0] nios2_jtag_debug_module_agent_rf_source_data;                                          // nios2_jtag_debug_module_agent:rf_source_data -> nios2_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [94:0] nios2_jtag_debug_module_agent_rsp_fifo_out_data;                                       // nios2_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_jtag_debug_module_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                                 // cmd_mux_003:src_valid -> nios2_jtag_debug_module_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                                  // cmd_mux_003:src_data -> nios2_jtag_debug_module_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                                 // nios2_jtag_debug_module_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                               // cmd_mux_003:src_channel -> nios2_jtag_debug_module_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                         // cmd_mux_003:src_startofpacket -> nios2_jtag_debug_module_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                           // cmd_mux_003:src_endofpacket -> nios2_jtag_debug_module_agent:cp_endofpacket
	...
	wire  [93:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> memory_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                                 // memory_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> memory_s1_agent:cp_channel
	...
	wire  [66:0] accelerometer_avalon_accelerometer_spi_mode_slave_agent_rp_data;                       // accelerometer_avalon_accelerometer_spi_mode_slave_agent:rp_data -> router_002:sink_data
	...
	wire         nios2_jtag_debug_module_agent_rp_valid;                                                // nios2_jtag_debug_module_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] nios2_jtag_debug_module_agent_rp_data;                                                 // nios2_jtag_debug_module_agent:rp_data -> router_005:sink_data
	wire         nios2_jtag_debug_module_agent_rp_ready;                                                // router_005:sink_ready -> nios2_jtag_debug_module_agent:rp_ready
	wire         nios2_jtag_debug_module_agent_rp_startofpacket;                                        // nios2_jtag_debug_module_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         nios2_jtag_debug_module_agent_rp_endofpacket;                                          // nios2_jtag_debug_module_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [93:0] memory_s1_agent_rp_data;                                                               // memory_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [66:0] accelerometer_avalon_accelerometer_spi_mode_slave_burst_adapter_source0_data;          // accelerometer_avalon_accelerometer_spi_mode_slave_burst_adapter:source0_data -> accelerometer_avalon_accelerometer_spi_mode_slave_agent:cp_data
	...
	wire   [4:0] accelerometer_avalon_accelerometer_spi_mode_slave_burst_adapter_source0_channel;       // accelerometer_avalon_accelerometer_spi_mode_slave_burst_adapter:source0_channel -> accelerometer_avalon_accelerometer_spi_mode_slave_agent:cp_channel
	...
	wire  [93:0] cmd_demux_001_src4_data;                                                               // cmd_demux_001:src4_data -> cmd_mux_004:sink1_data
	...
	wire  [93:0] rsp_demux_004_src1_data;                                                               // rsp_demux_004:src1_data -> rsp_mux_001:sink4_data
	...
	wire  [66:0] router_002_src_data;                                                                   // router_002:src_data -> accelerometer_avalon_accelerometer_spi_mode_slave_rsp_width_adapter:in_data
	...
	wire   [4:0] router_002_src_channel;                                                                // router_002:src_channel -> accelerometer_avalon_accelerometer_spi_mode_slave_rsp_width_adapter:in_channel
	...
	wire  [93:0] accelerometer_avalon_accelerometer_spi_mode_slave_rsp_width_adapter_src_data;          // accelerometer_avalon_accelerometer_spi_mode_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire   [4:0] accelerometer_avalon_accelerometer_spi_mode_slave_rsp_width_adapter_src_channel;       // accelerometer_avalon_accelerometer_spi_mode_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [93:0] cmd_mux_src_data;                                                                      // cmd_mux:src_data -> accelerometer_avalon_accelerometer_spi_mode_slave_cmd_width_adapter:in_data
	wire         cmd_mux_src_ready;                                                                     // accelerometer_avalon_accelerometer_spi_mode_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                                   // cmd_mux:src_channel -> accelerometer_avalon_accelerometer_spi_mode_slave_cmd_width_adapter:in_channel
	...
	wire  [66:0] accelerometer_avalon_accelerometer_spi_mode_slave_cmd_width_adapter_src_data;          // accelerometer_avalon_accelerometer_spi_mode_slave_cmd_width_adapter:out_data -> accelerometer_avalon_accelerometer_spi_mode_slave_burst_adapter:sink0_data
	...
	wire   [4:0] accelerometer_avalon_accelerometer_spi_mode_slave_cmd_width_adapter_src_channel;       // accelerometer_avalon_accelerometer_spi_mode_slave_cmd_width_adapter:out_channel -> accelerometer_avalon_accelerometer_spi_mode_slave_burst_adapter:sink0_channel
	...
	wire         nios2_jtag_debug_module_agent_rdata_fifo_src_valid;                                    // nios2_jtag_debug_module_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] nios2_jtag_debug_module_agent_rdata_fifo_src_data;                                     // nios2_jtag_debug_module_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         nios2_jtag_debug_module_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_003:in_0_ready -> nios2_jtag_debug_module_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                     // avalon_st_adapter_003:out_0_valid -> nios2_jtag_debug_module_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                      // avalon_st_adapter_003:out_0_data -> nios2_jtag_debug_module_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                     // nios2_jtag_debug_module_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                     // avalon_st_adapter_003:out_0_error -> nios2_jtag_debug_module_agent:rdata_fifo_sink_error
	...
	unsaved_mm_interconnect_0_router_003 router_005 (
	...
	unsaved_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
