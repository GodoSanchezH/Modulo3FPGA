...
module unsaved_mm_interconnect_0 (
		...
		output wire [1:0]  PORTD_s1_address,                          //                            PORTD_s1.address
		output wire        PORTD_s1_write,                            //                                    .write
		input  wire [31:0] PORTD_s1_readdata,                         //                                    .readdata
		output wire [31:0] PORTD_s1_writedata,                        //                                    .writedata
		output wire        PORTD_s1_chipselect,                       //                                    .chipselect
	...
	wire  [91:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                           // nios2_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> nios2_data_master_agent:rp_channel
	...
	wire  [91:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                       // nios2_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [4:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> nios2_instruction_master_agent:rp_channel
	...
	wire  [91:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [15:0] nios2_jtag_debug_module_agent_m0_address;                                    // nios2_jtag_debug_module_agent:m0_address -> nios2_jtag_debug_module_translator:uav_address
	...
	wire  [92:0] nios2_jtag_debug_module_agent_rf_source_data;                                // nios2_jtag_debug_module_agent:rf_source_data -> nios2_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [92:0] nios2_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_jtag_debug_module_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_jtag_debug_module_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // nios2_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> nios2_jtag_debug_module_agent:cp_channel
	...
	wire  [15:0] memory_s1_agent_m0_address;                                                  // memory_s1_agent:m0_address -> memory_s1_translator:uav_address
	...
	wire  [91:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> memory_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // memory_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> memory_s1_agent:cp_channel
	...
	wire  [31:0] portd_s1_agent_m0_readdata;                                                  // PORTD_s1_translator:uav_readdata -> PORTD_s1_agent:m0_readdata
	wire         portd_s1_agent_m0_waitrequest;                                               // PORTD_s1_translator:uav_waitrequest -> PORTD_s1_agent:m0_waitrequest
	wire         portd_s1_agent_m0_debugaccess;                                               // PORTD_s1_agent:m0_debugaccess -> PORTD_s1_translator:uav_debugaccess
	wire  [15:0] portd_s1_agent_m0_address;                                                   // PORTD_s1_agent:m0_address -> PORTD_s1_translator:uav_address
	wire   [3:0] portd_s1_agent_m0_byteenable;                                                // PORTD_s1_agent:m0_byteenable -> PORTD_s1_translator:uav_byteenable
	wire         portd_s1_agent_m0_read;                                                      // PORTD_s1_agent:m0_read -> PORTD_s1_translator:uav_read
	wire         portd_s1_agent_m0_readdatavalid;                                             // PORTD_s1_translator:uav_readdatavalid -> PORTD_s1_agent:m0_readdatavalid
	wire         portd_s1_agent_m0_lock;                                                      // PORTD_s1_agent:m0_lock -> PORTD_s1_translator:uav_lock
	wire  [31:0] portd_s1_agent_m0_writedata;                                                 // PORTD_s1_agent:m0_writedata -> PORTD_s1_translator:uav_writedata
	wire         portd_s1_agent_m0_write;                                                     // PORTD_s1_agent:m0_write -> PORTD_s1_translator:uav_write
	wire   [2:0] portd_s1_agent_m0_burstcount;                                                // PORTD_s1_agent:m0_burstcount -> PORTD_s1_translator:uav_burstcount
	wire         portd_s1_agent_rf_source_valid;                                              // PORTD_s1_agent:rf_source_valid -> PORTD_s1_agent_rsp_fifo:in_valid
	wire  [92:0] portd_s1_agent_rf_source_data;                                               // PORTD_s1_agent:rf_source_data -> PORTD_s1_agent_rsp_fifo:in_data
	wire         portd_s1_agent_rf_source_ready;                                              // PORTD_s1_agent_rsp_fifo:in_ready -> PORTD_s1_agent:rf_source_ready
	wire         portd_s1_agent_rf_source_startofpacket;                                      // PORTD_s1_agent:rf_source_startofpacket -> PORTD_s1_agent_rsp_fifo:in_startofpacket
	wire         portd_s1_agent_rf_source_endofpacket;                                        // PORTD_s1_agent:rf_source_endofpacket -> PORTD_s1_agent_rsp_fifo:in_endofpacket
	wire         portd_s1_agent_rsp_fifo_out_valid;                                           // PORTD_s1_agent_rsp_fifo:out_valid -> PORTD_s1_agent:rf_sink_valid
	wire  [92:0] portd_s1_agent_rsp_fifo_out_data;                                            // PORTD_s1_agent_rsp_fifo:out_data -> PORTD_s1_agent:rf_sink_data
	wire         portd_s1_agent_rsp_fifo_out_ready;                                           // PORTD_s1_agent:rf_sink_ready -> PORTD_s1_agent_rsp_fifo:out_ready
	wire         portd_s1_agent_rsp_fifo_out_startofpacket;                                   // PORTD_s1_agent_rsp_fifo:out_startofpacket -> PORTD_s1_agent:rf_sink_startofpacket
	wire         portd_s1_agent_rsp_fifo_out_endofpacket;                                     // PORTD_s1_agent_rsp_fifo:out_endofpacket -> PORTD_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> PORTD_s1_agent:cp_valid
	wire  [91:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> PORTD_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // PORTD_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> PORTD_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> PORTD_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> PORTD_s1_agent:cp_endofpacket
	wire         nios2_data_master_agent_cp_valid;                                            // nios2_data_master_agent:cp_valid -> router:sink_valid
	wire  [91:0] nios2_data_master_agent_cp_data;                                             // nios2_data_master_agent:cp_data -> router:sink_data
	...
	wire  [91:0] nios2_instruction_master_agent_cp_data;                                      // nios2_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [91:0] sysid_control_slave_agent_rp_data;                                           // sysid_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [91:0] nios2_jtag_debug_module_agent_rp_data;                                       // nios2_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [91:0] memory_s1_agent_rp_data;                                                     // memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire         portd_s1_agent_rp_valid;                                                     // PORTD_s1_agent:rp_valid -> router_006:sink_valid
	wire  [91:0] portd_s1_agent_rp_data;                                                      // PORTD_s1_agent:rp_data -> router_006:sink_data
	wire         portd_s1_agent_rp_ready;                                                     // router_006:sink_ready -> PORTD_s1_agent:rp_ready
	wire         portd_s1_agent_rp_startofpacket;                                             // PORTD_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         portd_s1_agent_rp_endofpacket;                                               // PORTD_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         portd_s1_agent_rdata_fifo_src_valid;                                         // PORTD_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] portd_s1_agent_rdata_fifo_src_data;                                          // PORTD_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         portd_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_004:in_0_ready -> PORTD_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> PORTD_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> PORTD_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // PORTD_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> PORTD_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (portd_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (portd_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (portd_s1_agent_m0_read),                    //                         .read
		.uav_write              (portd_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (portd_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (portd_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (portd_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (portd_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (portd_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (portd_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (portd_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (PORTD_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (PORTD_s1_write),                            //                         .write
		.av_readdata            (PORTD_s1_readdata),                         //                         .readdata
		.av_writedata           (PORTD_s1_writedata),                        //                         .writedata
		.av_chipselect          (PORTD_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                          //              (terminated)
		.av_begintransfer       (),                                          //              (terminated)
		.av_beginbursttransfer  (),                                          //              (terminated)
		.av_burstcount          (),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (portd_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (portd_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (portd_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (portd_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (portd_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (portd_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (portd_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (portd_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (portd_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (portd_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (portd_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (portd_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (portd_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (portd_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (portd_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (portd_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (portd_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (portd_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (portd_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (portd_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (portd_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (portd_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (portd_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (portd_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (portd_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (portd_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),         //                .error
		.rdata_fifo_src_ready    (portd_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (portd_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (portd_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) portd_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (portd_s1_agent_rf_source_data),             //        in.data
		.in_valid          (portd_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (portd_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (portd_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (portd_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (portd_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (portd_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (portd_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (portd_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (portd_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	unsaved_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (portd_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (portd_s1_agent_rp_valid),                   //          .valid
		.sink_data          (portd_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (portd_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (portd_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	unsaved_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (portd_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (portd_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (portd_s1_agent_rdata_fifo_src_ready),       //         .ready
