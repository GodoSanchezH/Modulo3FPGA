...
module unsaved_mm_interconnect_0 (
		...
		output wire [1:0]  LATX_s1_address,                           //                             LATX_s1.address
		output wire        LATX_s1_write,                             //                                    .write
		input  wire [31:0] LATX_s1_readdata,                          //                                    .readdata
		output wire [31:0] LATX_s1_writedata,                         //                                    .writedata
		output wire        LATX_s1_chipselect,                        //                                    .chipselect
		...
		output wire [1:0]  PORTX_s1_address,                          //                            PORTX_s1.address
		input  wire [31:0] PORTX_s1_readdata,                         //                                    .readdata
	...
	wire   [5:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> nios2_data_master_agent:rp_channel
	...
	wire   [5:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> nios2_instruction_master_agent:rp_channel
	...
	wire  [16:0] nios2_jtag_debug_module_agent_m0_address;                                    // nios2_jtag_debug_module_agent:m0_address -> nios2_jtag_debug_module_translator:uav_address
	...
	wire         cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> nios2_jtag_debug_module_agent:cp_valid
	wire  [92:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_jtag_debug_module_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // nios2_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> nios2_jtag_debug_module_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> nios2_jtag_debug_module_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> nios2_jtag_debug_module_agent:cp_endofpacket
	...
	wire  [31:0] latx_s1_agent_m0_readdata;                                                   // LATX_s1_translator:uav_readdata -> LATX_s1_agent:m0_readdata
	wire         latx_s1_agent_m0_waitrequest;                                                // LATX_s1_translator:uav_waitrequest -> LATX_s1_agent:m0_waitrequest
	wire         latx_s1_agent_m0_debugaccess;                                                // LATX_s1_agent:m0_debugaccess -> LATX_s1_translator:uav_debugaccess
	wire  [16:0] latx_s1_agent_m0_address;                                                    // LATX_s1_agent:m0_address -> LATX_s1_translator:uav_address
	wire   [3:0] latx_s1_agent_m0_byteenable;                                                 // LATX_s1_agent:m0_byteenable -> LATX_s1_translator:uav_byteenable
	wire         latx_s1_agent_m0_read;                                                       // LATX_s1_agent:m0_read -> LATX_s1_translator:uav_read
	wire         latx_s1_agent_m0_readdatavalid;                                              // LATX_s1_translator:uav_readdatavalid -> LATX_s1_agent:m0_readdatavalid
	wire         latx_s1_agent_m0_lock;                                                       // LATX_s1_agent:m0_lock -> LATX_s1_translator:uav_lock
	wire  [31:0] latx_s1_agent_m0_writedata;                                                  // LATX_s1_agent:m0_writedata -> LATX_s1_translator:uav_writedata
	wire         latx_s1_agent_m0_write;                                                      // LATX_s1_agent:m0_write -> LATX_s1_translator:uav_write
	wire   [2:0] latx_s1_agent_m0_burstcount;                                                 // LATX_s1_agent:m0_burstcount -> LATX_s1_translator:uav_burstcount
	wire         latx_s1_agent_rf_source_valid;                                               // LATX_s1_agent:rf_source_valid -> LATX_s1_agent_rsp_fifo:in_valid
	wire  [93:0] latx_s1_agent_rf_source_data;                                                // LATX_s1_agent:rf_source_data -> LATX_s1_agent_rsp_fifo:in_data
	wire         latx_s1_agent_rf_source_ready;                                               // LATX_s1_agent_rsp_fifo:in_ready -> LATX_s1_agent:rf_source_ready
	wire         latx_s1_agent_rf_source_startofpacket;                                       // LATX_s1_agent:rf_source_startofpacket -> LATX_s1_agent_rsp_fifo:in_startofpacket
	wire         latx_s1_agent_rf_source_endofpacket;                                         // LATX_s1_agent:rf_source_endofpacket -> LATX_s1_agent_rsp_fifo:in_endofpacket
	wire         latx_s1_agent_rsp_fifo_out_valid;                                            // LATX_s1_agent_rsp_fifo:out_valid -> LATX_s1_agent:rf_sink_valid
	wire  [93:0] latx_s1_agent_rsp_fifo_out_data;                                             // LATX_s1_agent_rsp_fifo:out_data -> LATX_s1_agent:rf_sink_data
	wire         latx_s1_agent_rsp_fifo_out_ready;                                            // LATX_s1_agent:rf_sink_ready -> LATX_s1_agent_rsp_fifo:out_ready
	wire         latx_s1_agent_rsp_fifo_out_startofpacket;                                    // LATX_s1_agent_rsp_fifo:out_startofpacket -> LATX_s1_agent:rf_sink_startofpacket
	wire         latx_s1_agent_rsp_fifo_out_endofpacket;                                      // LATX_s1_agent_rsp_fifo:out_endofpacket -> LATX_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> LATX_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> LATX_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // LATX_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> LATX_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> LATX_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> LATX_s1_agent:cp_endofpacket
	wire  [31:0] portx_s1_agent_m0_readdata;                                                  // PORTX_s1_translator:uav_readdata -> PORTX_s1_agent:m0_readdata
	wire         portx_s1_agent_m0_waitrequest;                                               // PORTX_s1_translator:uav_waitrequest -> PORTX_s1_agent:m0_waitrequest
	wire         portx_s1_agent_m0_debugaccess;                                               // PORTX_s1_agent:m0_debugaccess -> PORTX_s1_translator:uav_debugaccess
	wire  [16:0] portx_s1_agent_m0_address;                                                   // PORTX_s1_agent:m0_address -> PORTX_s1_translator:uav_address
	wire   [3:0] portx_s1_agent_m0_byteenable;                                                // PORTX_s1_agent:m0_byteenable -> PORTX_s1_translator:uav_byteenable
	wire         portx_s1_agent_m0_read;                                                      // PORTX_s1_agent:m0_read -> PORTX_s1_translator:uav_read
	wire         portx_s1_agent_m0_readdatavalid;                                             // PORTX_s1_translator:uav_readdatavalid -> PORTX_s1_agent:m0_readdatavalid
	wire         portx_s1_agent_m0_lock;                                                      // PORTX_s1_agent:m0_lock -> PORTX_s1_translator:uav_lock
	wire  [31:0] portx_s1_agent_m0_writedata;                                                 // PORTX_s1_agent:m0_writedata -> PORTX_s1_translator:uav_writedata
	wire         portx_s1_agent_m0_write;                                                     // PORTX_s1_agent:m0_write -> PORTX_s1_translator:uav_write
	wire   [2:0] portx_s1_agent_m0_burstcount;                                                // PORTX_s1_agent:m0_burstcount -> PORTX_s1_translator:uav_burstcount
	wire         portx_s1_agent_rf_source_valid;                                              // PORTX_s1_agent:rf_source_valid -> PORTX_s1_agent_rsp_fifo:in_valid
	wire  [93:0] portx_s1_agent_rf_source_data;                                               // PORTX_s1_agent:rf_source_data -> PORTX_s1_agent_rsp_fifo:in_data
	wire         portx_s1_agent_rf_source_ready;                                              // PORTX_s1_agent_rsp_fifo:in_ready -> PORTX_s1_agent:rf_source_ready
	wire         portx_s1_agent_rf_source_startofpacket;                                      // PORTX_s1_agent:rf_source_startofpacket -> PORTX_s1_agent_rsp_fifo:in_startofpacket
	wire         portx_s1_agent_rf_source_endofpacket;                                        // PORTX_s1_agent:rf_source_endofpacket -> PORTX_s1_agent_rsp_fifo:in_endofpacket
	wire         portx_s1_agent_rsp_fifo_out_valid;                                           // PORTX_s1_agent_rsp_fifo:out_valid -> PORTX_s1_agent:rf_sink_valid
	wire  [93:0] portx_s1_agent_rsp_fifo_out_data;                                            // PORTX_s1_agent_rsp_fifo:out_data -> PORTX_s1_agent:rf_sink_data
	wire         portx_s1_agent_rsp_fifo_out_ready;                                           // PORTX_s1_agent:rf_sink_ready -> PORTX_s1_agent_rsp_fifo:out_ready
	wire         portx_s1_agent_rsp_fifo_out_startofpacket;                                   // PORTX_s1_agent_rsp_fifo:out_startofpacket -> PORTX_s1_agent:rf_sink_startofpacket
	wire         portx_s1_agent_rsp_fifo_out_endofpacket;                                     // PORTX_s1_agent_rsp_fifo:out_endofpacket -> PORTX_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> PORTX_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> PORTX_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // PORTX_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> PORTX_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> PORTX_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> PORTX_s1_agent:cp_endofpacket
	...
	wire         nios2_jtag_debug_module_agent_rp_valid;                                      // nios2_jtag_debug_module_agent:rp_valid -> router_004:sink_valid
	wire  [92:0] nios2_jtag_debug_module_agent_rp_data;                                       // nios2_jtag_debug_module_agent:rp_data -> router_004:sink_data
	wire         nios2_jtag_debug_module_agent_rp_ready;                                      // router_004:sink_ready -> nios2_jtag_debug_module_agent:rp_ready
	wire         nios2_jtag_debug_module_agent_rp_startofpacket;                              // nios2_jtag_debug_module_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         nios2_jtag_debug_module_agent_rp_endofpacket;                                // nios2_jtag_debug_module_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         latx_s1_agent_rp_valid;                                                      // LATX_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] latx_s1_agent_rp_data;                                                       // LATX_s1_agent:rp_data -> router_006:sink_data
	wire         latx_s1_agent_rp_ready;                                                      // router_006:sink_ready -> LATX_s1_agent:rp_ready
	wire         latx_s1_agent_rp_startofpacket;                                              // LATX_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         latx_s1_agent_rp_endofpacket;                                                // LATX_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         portx_s1_agent_rp_valid;                                                     // PORTX_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] portx_s1_agent_rp_data;                                                      // PORTX_s1_agent:rp_data -> router_007:sink_data
	wire         portx_s1_agent_rp_ready;                                                     // router_007:sink_ready -> PORTX_s1_agent:rp_ready
	wire         portx_s1_agent_rp_startofpacket;                                             // PORTX_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         portx_s1_agent_rp_endofpacket;                                               // PORTX_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         nios2_jtag_debug_module_agent_rdata_fifo_src_valid;                          // nios2_jtag_debug_module_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] nios2_jtag_debug_module_agent_rdata_fifo_src_data;                           // nios2_jtag_debug_module_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         nios2_jtag_debug_module_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_002:in_0_ready -> nios2_jtag_debug_module_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> nios2_jtag_debug_module_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> nios2_jtag_debug_module_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                           // nios2_jtag_debug_module_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> nios2_jtag_debug_module_agent:rdata_fifo_sink_error
	...
	wire         latx_s1_agent_rdata_fifo_src_valid;                                          // LATX_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] latx_s1_agent_rdata_fifo_src_data;                                           // LATX_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         latx_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_004:in_0_ready -> LATX_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> LATX_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> LATX_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // LATX_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> LATX_s1_agent:rdata_fifo_sink_error
	wire         portx_s1_agent_rdata_fifo_src_valid;                                         // PORTX_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] portx_s1_agent_rdata_fifo_src_data;                                          // PORTX_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         portx_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_005:in_0_ready -> PORTX_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> PORTX_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> PORTX_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // PORTX_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> PORTX_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (latx_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (latx_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (latx_s1_agent_m0_read),                     //                         .read
		.uav_write              (latx_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (latx_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (latx_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (latx_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (latx_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (latx_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (latx_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (latx_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (LATX_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (LATX_s1_write),                             //                         .write
		.av_readdata            (LATX_s1_readdata),                          //                         .readdata
		.av_writedata           (LATX_s1_writedata),                         //                         .writedata
		.av_chipselect          (LATX_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                          //              (terminated)
		.av_begintransfer       (),                                          //              (terminated)
		.av_beginbursttransfer  (),                                          //              (terminated)
		.av_burstcount          (),                                          //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (portx_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (portx_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (portx_s1_agent_m0_read),                    //                         .read
		.uav_write              (portx_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (portx_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (portx_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (portx_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (portx_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (portx_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (portx_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (portx_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (PORTX_s1_address),                          //      avalon_anti_slave_0.address
		.av_readdata            (PORTX_s1_readdata),                         //                         .readdata
		.av_write               (),                                          //              (terminated)
		.av_read                (),                                          //              (terminated)
		.av_writedata           (),                                          //              (terminated)
		.av_begintransfer       (),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (latx_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (latx_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (latx_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (latx_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (latx_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (latx_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (latx_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (latx_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (latx_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (latx_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (latx_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (latx_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (latx_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (latx_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (latx_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (latx_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (latx_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (latx_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (latx_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (latx_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (latx_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (latx_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (latx_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (latx_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (latx_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (latx_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),         //                .error
		.rdata_fifo_src_ready    (latx_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (latx_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (latx_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) latx_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (latx_s1_agent_rf_source_data),              //        in.data
		.in_valid          (latx_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (latx_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (latx_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (latx_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (latx_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (latx_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (latx_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (latx_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (latx_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (portx_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (portx_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (portx_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (portx_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (portx_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (portx_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (portx_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (portx_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (portx_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (portx_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (portx_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (portx_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (portx_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (portx_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (portx_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (portx_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (portx_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (portx_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (portx_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (portx_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (portx_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (portx_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (portx_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (portx_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (portx_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (portx_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),         //                .error
		.rdata_fifo_src_ready    (portx_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (portx_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (portx_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) portx_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (portx_s1_agent_rf_source_data),             //        in.data
		.in_valid          (portx_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (portx_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (portx_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (portx_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (portx_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (portx_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (portx_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (portx_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (portx_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	unsaved_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (latx_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (latx_s1_agent_rp_valid),                    //          .valid
		.sink_data          (latx_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (latx_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (latx_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	unsaved_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (portx_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (portx_s1_agent_rp_valid),                   //          .valid
		.sink_data          (portx_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (portx_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (portx_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	unsaved_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (latx_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (latx_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (latx_s1_agent_rdata_fifo_src_ready),        //         .ready
	...
	unsaved_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (portx_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (portx_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (portx_s1_agent_rdata_fifo_src_ready),       //         .ready
