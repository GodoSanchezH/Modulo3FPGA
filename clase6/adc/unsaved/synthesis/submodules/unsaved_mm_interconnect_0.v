...
module unsaved_mm_interconnect_0 (
	...
	wire  [17:0] adc_adc_slave_agent_m0_address;                                              // adc_adc_slave_agent:m0_address -> adc_adc_slave_translator:uav_address
	...
	wire  [94:0] adc_adc_slave_agent_rf_source_data;                                          // adc_adc_slave_agent:rf_source_data -> adc_adc_slave_agent_rsp_fifo:in_data
	...
	wire  [94:0] adc_adc_slave_agent_rsp_fifo_out_data;                                       // adc_adc_slave_agent_rsp_fifo:out_data -> adc_adc_slave_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> adc_adc_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                           // adc_adc_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [5:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> adc_adc_slave_agent:cp_channel
	...
	wire   [5:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> nios2_jtag_debug_module_agent:cp_channel
	...
	wire  [93:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> leds_s1_agent:cp_data
	...
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> memory_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> memory_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // memory_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> memory_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> memory_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> memory_s1_agent:cp_endofpacket
	...
	wire  [93:0] adc_adc_slave_agent_rp_data;                                                 // adc_adc_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [93:0] leds_s1_agent_rp_data;                                                       // leds_s1_agent:rp_data -> router_006:sink_data
	...
	wire         memory_s1_agent_rp_valid;                                                    // memory_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] memory_s1_agent_rp_data;                                                     // memory_s1_agent:rp_data -> router_007:sink_data
	wire         memory_s1_agent_rp_ready;                                                    // router_007:sink_ready -> memory_s1_agent:rp_ready
	wire         memory_s1_agent_rp_startofpacket;                                            // memory_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         memory_s1_agent_rp_endofpacket;                                              // memory_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [93:0] cmd_demux_001_src5_data;                                                     // cmd_demux_001:src5_data -> cmd_mux_005:sink1_data
	...
	wire  [93:0] rsp_demux_005_src1_data;                                                     // rsp_demux_005:src1_data -> rsp_mux_001:sink5_data
	...
	wire         memory_s1_agent_rdata_fifo_src_valid;                                        // memory_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] memory_s1_agent_rdata_fifo_src_data;                                         // memory_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         memory_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_005:in_0_ready -> memory_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> memory_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> memory_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // memory_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> memory_s1_agent:rdata_fifo_sink_error
